...
syn cluster mailQuoteExps	contains=mailQuoteExp1,mailQuoteExp2,mailQuoteExp3,mailQuoteExp4,mailQuoteExp5,mailQuoteExp6,mailQuoteDiffChunk,mailQuoteDiffRemoved,mailQuoteDiffAdded,mailQuoteDiffMeta
...
syn match mailQuoteDiffMeta	contained contains=@NoSpell "\v^\> \zs(--- a/.*)$"
syn match mailQuoteDiffMeta	contained contains=@NoSpell "\v^\> \zs(\+\+\+ b/.*)$"
syn match mailQuoteDiffMeta	contained contains=@NoSpell "\v^\> \zs(index [a-f0-9]+.*)$"
...
syn region	mailQuoted1	keepend contains=mailQuoteDiffChunk,mailQuoteDiffRemoved,mailQuoteDiffAdded,mailQuoteDiffMeta,mailQuoted2,mailQuoted3,mailQuoted4,mailQuoted5,mailQuoted6,mailVerbatim,mailHeader,@mailLinks,mailSignature,@NoSpell start="^\z([a-z]\+>\|[]|}>]\)" end="^\z1\@!" fold
